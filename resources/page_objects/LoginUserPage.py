...
class LoginUserPage(BasePage):
    ...
    def login_user(self, email, password):
        with allure.step(f"логинимся пользователем {email} на портал"):
    ...
    def login_admin_user(self, username, password):
        with allure.step(f"логинимся пользователем {username} в админку"):
    ...
    def navigate_to_homepage(self):
        with allure.step(f"переходим на домашнюю страницу"):
